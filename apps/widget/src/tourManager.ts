...
export class TourManager implements ITourManager {
  ...
  private async createTooltip(step: TourStep, targetElement: HTMLElement, stepIndex: number): Promise<void> {
        ...
        <div class="tour-tooltip-footer">
          <div class="tour-progress">
            ...
            <div class="tour-progress-bar">
              <div class="tour-progress-fill" style="width: ${((stepIndex + 1) / totalSteps) * 100}%"></div>
            </div>
          </div>
          <div class="tour-tooltip-actions">
            <button class="tour-btn tour-btn-secondary tour-skip-btn">Skip Tour</button>
            ${!isFirst ? '<button class="tour-btn tour-btn-secondary tour-prev-btn">← Back</button>' : ''}
    ...
    await TooltipHelper.positionTooltip(this.tooltip, targetElement, step.position);
    
    // Set up auto-update on scroll/resize
    const cleanup = TooltipHelper.createAutoUpdate(this.tooltip, targetElement, step.position);
